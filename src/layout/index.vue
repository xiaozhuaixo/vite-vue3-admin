...
export default {
  ...
  components: {
    ...
    AppMain: defineAsyncComponent((() => import('./components/AppMain'))),
      TagsView: defineAsyncComponent(() => import('./components/TagsView')),
      RightPanel: defineAsyncComponent(() => import('@/components/RightPanel')),
      Settings: defineAsyncComponent(() => import('./components/Settings'))
  },
  mixins: [ResizeMixin],
  computed: {
      ...mapState({
